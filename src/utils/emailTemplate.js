  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <p>Please take a moment to verify your email for CoWriter, Edit in Real time</p>
        <div style="text-align: center; margin-top: 20px;">
          <h2>Hello ${username},</h2>
          <p>CoWriter appreciates your commitment to securing your account. To proceed, kindly click the button below to verify your email:</p>
